...
function lapizzeria_styles(){
    ...
    wp_register_style('googlefont', 'https://fonts.googleapis.com/css?family=Open+Sans:400,700|Raleway:400,700,900', '1.0.0' );
    wp_register_style('fluidbox', get_template_directory_uri(). '/css/fluidbox.min.css', array(), '8.0.1');
    wp_register_style('normalize', get_template_directory_uri(). '/css/normalize.css', array(), '8.0.1');
    wp_register_style('fontawesome', get_template_directory_uri(). '/css/font-awesome.css', array(), '5.8.1');
...
function lapizzeria_specialties(){
    ...
    $labels = array(
        ...
        'name_admin_bar'     => _x('Pizzas', 'lapizzeria'),
